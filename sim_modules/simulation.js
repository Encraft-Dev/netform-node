...
exports.simulate = function(oData){return netformSimulation(oData)}


function netformSimulation(oData){
	//SIMTIME,SEED,SLOTS)
	//set simulation parameters
	//console.log(Sim)
	var sim = new SIM.Sim("Netform");
	console.log(sim)
...
// 				 			period =  period > 47 ? 0: period
// 				 			genSolar =  Park.solarGeneration.periodOutput("May",period)
//  							this.log.push({Veh:this.vehStatus,Cap:Park.caps(),Park:Park.status()})
//  			               	this.vehStatus=[];
